<div class="biogrid">
    <div>
        <img src="<?php the_field('agent_photo_1')?>" alt="<?php the_field('agent_name_1')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_2')?>" alt="<?php the_field('agent_name_2')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_3')?>" alt="<?php the_field('agent_name_3')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_4')?>" alt="<?php the_field('agent_name_4')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_5')?>" alt="<?php the_field('agent_name_5')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_7')?>" alt="<?php the_field('agent_name_7')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_9')?>" alt="<?php the_field('agent_name_9')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_10')?>" alt="<?php the_field('agent_name_10')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_11')?>" alt="<?php the_field('agent_name_11')?>" />
        <span class="info">
    ...
    <div>
        <img src="<?php the_field('agent_photo_12')?>" alt="<?php the_field('agent_name_12')?>" />
        <span class="info">
