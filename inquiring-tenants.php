<div class="accordion-container">
    <h2 id="inquiring-tenants">Inquiring Tenants</h2>

    <div class="accordion-tab active">
        <i class="fas fa-chevron-circle-up active-arrow"></i> HOW FAST DO YOU GET APPLICATIONS PROCESSED?
        <div class="tab-info active">
        Our goal is to process your applications as quickly as possible so that you will be able to make a determination on your housing needs without delay. Unfortunately, sometimes we are held up in this endeavor because of our inability to get a hold of previous landlords, current landlords, or employers.
        <p>
        Normally an application process takes 24 hours to complete. The more information you can provide on your Application, the easier it is to complete processing. <strong>WE WILL NOT BE ABLE TO WORK ON YOUR APPLICATION IF IT IS NOT SIGNED AND DATED.</strong> Signing the paperwork authorizes us to do the background checks and the people we make the inquiries to, to release information.
        </p>    
    </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MUCH IS THE APPLICATION FEE AND IS IT REFUNDABLE?
        <div class="tab-info">
        Applicants with roommates will need separate applications. Non-refundable Application fees vary with the property and property manager and are subject to change at anytime. Having said that, usually they are $60.00. These funds need to be in the form of cashiers check or money order.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHAT HAPPENS IF I HAVE BAD CREDIT?
        <div class="tab-info">
        We take every applicant on a case by case basis. Sometimes a tenants understanding of what bad credit is, isn't necessarily something we would view as a problem. Of course the opposite is true as well. Assuming your assessment is correct, then there is still a possibility that you would get accepted if the owner was willing to overlook your past credit problems.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHAT DO YOU LOOK AT OR CHECK ON WITH MY APPLICATION?
        <div class="tab-info">
        We verify all the key areas like previous rental history, general credit, employment, and on occasion references. Keep in mind that our application fees are non-refundable. If you know for sure you have bad credit, maybe even an eviction, you might want to think twice or at least have a heart-to-heart discussion with the property manager before risking your time and money.... it's your call.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW SOON CAN I MOVE IN?
        <div class="tab-info">
        Getting the keys is of course very simple, but for some people circumstances make it difficult. We do not release keys to anyone unless all of the following criteria are met...
        <ol>
            <li>Your application is approved and ALL of your lease paperwork has been signed by ALL parties.</li>
            <li>ALL required funds have been received for rent and security deposit in the form of cashiers check or money order.</li>
        </ol>
        That's it.... simple.
        </div>
    </div>
...
Clark County, Nevada for a Period of ___ month(s), commencing on the __ day of __ , 20 <strong>at a monthly rate of $__</strong> payable in advance on the <strong>FIRST</strong> day of each and every month. Payments will be accepted at 4033 W. Charleston Blvd. Las Vegas, Nevada 89102 during normal business hours Monday through Friday, not including holidays, unless otherwise agreed to. Rent payments are legally the responsibility of the LESSEE without notice or demand and may be acted upon anytime after the due date stated above. The LESSEE is responsible for all lease payments through the end of the lease term. All payments received on LESSEES account will <strong>FIRST</strong> be applied to late fees, repairs, utilities, returned check charges, and all other miscellaneous LESSEE charges and <strong>SECOND</strong> to rent due. At the end of the lease term this agreement will automatically become a month-to-month agreement with all of the stated provisions herein intact, unless a lease renewal or new lease has been signed and agreed upon. The Atlas Group LC may make changes to this agreement at any time with proper written notice being given to LESSEE.
        <p>
            <strong>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHEN IS RENT DUE?
        <div class="tab-info">
        Rent is due on or before the first of the month. Don't let when rent becomes "late", confuse you with when it is actually due. These are two entirely separate time lines. You can pay your rent anytime before it is due.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHO DO I MAKE MY RENTAL PAYMENTS TO?
        <div class="tab-info">
        You will always make your payments out to us. We process the payment s and do the accounting for the different owners. If you are a Section 8 recipient, then HUD will also send the owners checks to us. Most of our tenants make their payments electronically, online or by going to their local 7-11 store.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> DO YOU COME AND PICK UP THE RENT PAYMENTS?
        <div class="tab-info">
        No. Most tenants pay online through their bank account or credit card. Or, many tenants have "Bill Pay" through their bank handle their payments for them. You can also pay at any 7-11. In additiona we can provide you with mail in stickers if you would like. Otherwise we hold regular business hours for making payments at the office.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> I HAVE A BUSINESS AND I WORK OUT OF MY HOME, IS THAT "OK"?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MUCH DO I HAVE TO PAY TO HOLD THE PROPERTY?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> MY SPOUSE WORKS, CAN I JUST SIGN THE LEASE SO WE CAN MOVE-IN?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MUCH IS THE SECURITY DEPOSIT AND WILL I GET IT BACK WHEN I LEAVE?
        <div class="tab-info">
        The Security Deposit varies with each property and is usually around 90% of the rent. Sometimes it can be more and sometimes it is less. It depends on the situation and the owners requirements. Getting your Security Deposit back depends entirely on you. If you stick to all the requirements of the lease, give proper notice, and leave the property in a condition that we can immediately rent it with out having to do any repairs or cleaning, then you should get your Deposit returned.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MANY KEYS WILL I GET?
        <div class="tab-info">
        Normally we give you one set of keys and one gate and/or garage door opener if appropriate for the property. If you would like more sets then it will be your responsibility to have duplicate keys made and purchase additional remote controls. In the event you change locks on the property, it is imperative that you supply our office with a copy of the keys. Not to do so would be considered a lease violation and as such you could be evicted.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MUCH IS THE CLEANING CHARGE AND IS IT REFUNDABLE?
        <div class="tab-info">
        We don't charge a cleaning fee, per se. We have found that when tenants do not have an opportunity of getting a refund, then there isn't any incentive for them to clean the property once they have vacated.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MUCH ARE LATE FEES AND WHEN DO THEY BEGIN?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> IF I NEED TO MOVE CAN I SUBLET THE PROPERTY?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW MANY PEOPLE CAN LIVE IN A PROPERTY?
        <div class="tab-info">
        We use the Federal guidelines of 2.5 people per bedroom. So, as an example, a property with three (3) bedrooms could hold 7.5 people.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> CAN I HAVE A PET?
        <div class="tab-info">
        Sure... how about a "Pet Rock"? Pets can be a tuff sell, depending on what it is. Normally, non-destructive animals are "ok" like reptiles, birds, fish etc. Each situation is looked at on a case by case basis. There is a $300.00 additional refundable deposit per head for each animal that is allowed on the property.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> I LIKE TO WORK ON CARS AS A HOBBY, WILL THAT BE A PROBLEM?
        <div class="tab-info">
        It could be. We do not allow you to have or conduct your own "Lube and Tune" on the property. If the vehicle in question is inside a closed garage, there probably won't be a problem. The vehicle won't be an eyesore for the neighborhood or neighbors and it won't present a hazard to kids.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> CAN I REPAINT OR FIX-UP THE PROPERTY?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> IF I GET BEHIND IN MY RENT, HOW SOON WILL IT BE BEFORE I'M EVICTED?
        <div class="tab-info">
        It takes two (2) weeks after the Five Day Pay Or Quit notice has been posted to get you through the legal process and evicted.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WILL I NEED TO GIVE ANY NOTICE WHEN I'M GOING TO MOVE?
        <div class="tab-info">
        Yes of course, and it must be in writing and follow certain procedures. It has to be given a <strong>minimum</strong> of 30 days in advance and we need to receive it at the beginning of the month... not in the middle.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHAT IF THERE IS AN EMERGENCY, WHO DO I GET INTOUCH WITH?
        <div class="tab-info">
        We have an answering service that is on call 24/7. You should only call them for REAL emergencies like a flood, broken gas or water pipe, fire. Something that is damaging the property. Otherwise, you will be charged for the expense of the answering service call.
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> CAN YOU JUST COME IN MY PLACE ANYTIME YOU WANT?
        <div class="tab-info">
        No, except of course if you let us in. We normally have to give you 24 hours notice. An exception to that would be if there was an emergency.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> DO YOU THINK THE OWNER WILL WANT TO SELL THIS PLACE?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> WHAT HAPPENS IF I GET ROBBED OR BROKEN INTO?
        <div class="tab-info">
        It's not the owners responsibility to protect you or your personal belongings. Your losses are not his losses. You need to carry your own insurance just as the owner carries insurance to protect what is his, namely the property.
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> HOW SOON DO YOU ANSWER MAINTENANCE REQUESTS?
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> IS THE OWNER GOING TO PUT A PATIO OR YARD IN THE BACK? 
        <div class="tab-info">
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> DO YOU DO A LEASE WITH OPTION TO BUY?
        <div class="tab-info">
        We advise our owners against it. There are a lot of legal issues involved. It's better for everyone to keep leases and purchases separate and not intermixed.
        </div>
    </div>
