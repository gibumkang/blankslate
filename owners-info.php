<div class="accordion-container">
    ...
    <div class="accordion-tab active">
        <i class="fas fa-chevron-circle-up active-arrow"></i> Company Overview
        ...
        <ul>
            ...
            <li>Property Management Committee - GLVAR</li>
        </ul>
        <h3>Location</h3>
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Buying and Selling
        <div class="tab-info">
        <h3>We don't "push" you to buy or sell:</h3>
        <p>
...
<       /p>
        <h3>Using us gives you several advantages:</h3>
        <p>
        ...
        <h3>Widen your opportunities:</h3>
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Investing 101
        <div class="tab-info">
        <p>
        ...
        <h3>You Make Your Money When You Buy!:</h3>
        <p>
        ...
        <h3>What is the Best Location?:</h3>
        <p>
        ...
        <h3>What Amenities to look for:</h3>
        <p>
        ...
        <h3>Imposing your Likes and Dislikes into the decision process:</h3>
        <p>
        ...
        <p>
            <strong>LOCATION, LOCATION, LOCATION</strong> - Where is the best area of town to buy a rental property? The answer is simple anywhere you can make money. It really doesn't matter if you are in a statistically high crime area or not, as long as the price you pay for the property allows you the opportunity to meet your financial objectives. Everyone has to live somewhere.
        </p>
        <p>
        ...
        <p>
            <strong>PROPERTY TYPES</strong> - Another question we get constantly is which property type is better? Here again, any type where you can make money. Every property has it's advantages and disadvantages.
        </p>
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Services Provided
        <div class="tab-info">
            <ol>
                <li>Acquire tenants in a rapid and aggressive manner.</li>
                <li>Qualify prospective tenants with complete credit, employment and rental history</li>
                <li>Perform timely rent collection and if necessary initiate collection efforts</li>
                <li>Pay mortgage, homeowners association dues, utilities, property taxes, sewer etc. as requested/needed</li>
                <li>Effect any necessary repairs in a timely and professional manner. All repairs are done by a pre-qualified licensed, bonded and insured contractor.</li>
                <li>Send monthly statements to all clients promptly, complete with copies of all invoices/expenses paid.</li>
                <li>Handle any and all property/tenant problems. Interface with insurance companies, City Departments, police etc.</li>
                <li>Effect evictions, go to court, handle and monitor forced move-out proceedings.</li>
                <li>Perform normal move-outs. Make determination of Security Deposit refunds according to Nevada Revised Statute guidelines.</li>
                <li>Complete property renovation, cleaning, repairs, and begin process again.</li>
            </ol>
        </div>
    </div>

    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Rates & Fees
        <div class="tab-info">
        <h3>Rates</h3>
        <p>
        ...
        <ul>
            <li>5% Apartment Complexes over 50 units at one location with onsite managers.*</li>
            <li>8% Multiple Units 40 or more- Multiple Buildings/Locations.*</li>
            <li>9% New Single Family Homes, Condos, Townhomes for the first year</li>
            <li>10% Older Single Family Homes, Condos, Townhomes, Duplex, Tri-Plex, Four-Plex's, smaller Apartment Buildings*</li>
            <li>11%-15% Properties that are up for sale through someone else. Small, single units under $400 per month, or any property needing special attention.*</li>
        </ul>
        <p>
            <em>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Tenant Placement
        <div class="tab-info">
        <h3>What is the charge for?</h3>
        <p>
    ...
    <div class="accordion-tab">
        <i class="fas fa-chevron-circle-up"></i> Utilities & Appliances
        <div class="tab-info">
            <p>
                <strong>APPLIANCES</strong> - Probably the best course of action if you have older appliances is to get a Home Warranty Protection plan that covers them. Otherwise, be prepared to fix them when they breakdown.
            </p>
            <p>
